...
const PAIRS: [string, keyof WidgetColors, keyof WidgetColors, number][] = [
  ...
  ["action note", "noticeInk", "noticeSurface", TEXT_MINIMUM],
  ["action note reference", "inkMuted", "noticeSurface", TEXT_MINIMUM],
  ["form error", "dangerInk", "dangerSurface", TEXT_MINIMUM],
  ["source viewer excerpt", "ink", "surfaceMuted", TEXT_MINIMUM],
  ["source viewer meta labels", "inkMuted", "surface", TEXT_MINIMUM],
  ["source viewer loading status", "inkMuted", "surface", TEXT_MINIMUM],
  ["source viewer error", "dangerInk", "dangerSurface", TEXT_MINIMUM],
  ...
  ["citation number badge", "accentInk", "accent", TEXT_MINIMUM],
