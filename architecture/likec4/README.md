...
This directory models the system and its reference Kubernetes deployment.
Calendar, CRM, notification, streaming, high-availability, and managed-data
services remain in [`BACKLOG.md`](../../BACKLOG.md).
...
| [`agent_runtime`](diagrams/agent_runtime.png) | The `dispatch@3` LangGraph path and deterministic tool boundary |
...
The final view keeps its historical filename for link compatibility and shows
the repository's reference deployment topology. High availability is tracked
